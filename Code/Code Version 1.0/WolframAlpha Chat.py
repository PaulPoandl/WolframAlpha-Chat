...
class ChatWindow(tk.Tk):
    def __init__(self):
        ...
        self.iconbitmap("WolframAlpha.ico")
    ...
    def load_app_id(self):
        try:
            with open("app_id_WolframAlpha.txt", "r") as file:
                return file.read().strip()
        except FileNotFoundError:
            return ""
    def save_app_id(self, app_id):
        with open("app_id_WolframAlpha.txt", "w") as file:
            file.write(app_id)
...
class MathButtonWindow:
    def __init__(self, master, insert_function):
        ...
        self.master.iconbitmap("WolframAlpha.ico")
